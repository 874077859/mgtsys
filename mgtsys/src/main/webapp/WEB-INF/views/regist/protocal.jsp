...
<body data-type="protocal" class="theme-black" ng-app="myApp" ng-controller="protocalCtr">
  <div class="protocal">
    <div class="title-info">用户注册协议</div>
    <p>
      <span class="subtitle-info">一、总则</span><br/>
      1.1 VIP之家的所有权和运营权归武汉市迅捷科技有限公司所有。 <br/>
      1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与VIP之家之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。  <br/>
      1.3 本协议则可由VIP之家随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。  
    </p>
    <p>
      <span class="subtitle-info">二、服务内容</span><br/>
      2.1 VIP之家的具体内容由本站根据实际情况提供。 <br/>
      2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。
    </p>
    <p>
      <span class="subtitle-info">三、用户帐号</span><br/>
    ...
    <p>
      <span class="subtitle-info">四、使用规则</span><br/>
      ...
      <span class="protocal-span">(1)违反宪法确定的基本原则的；</span> <br/>
      <span class="protocal-span">(2)危害国家安全，泄漏国家机密，颠覆国家政权，破坏国家统一的；</span><br/>
      <span class="protocal-span">(3)损害国家荣誉和利益的；</span><br/>
      <span class="protocal-span">(4)煽动民族仇恨、民族歧视，破坏民族团结的；</span><br/>
      <span class="protocal-span">(5)破坏国家宗教政策，宣扬邪教和封建迷信的；</span><br/>
      <span class="protocal-span">(6)散布谣言，扰乱社会秩序，破坏社会稳定的；</span><br/>
      <span class="protocal-span">(7)散布淫秽、色情、赌博、暴力、恐怖或者教唆犯罪的；</span><br/>
      <span class="protocal-span">(8)侮辱或者诽谤他人，侵害他人合法权益的；</span><br/>
      <span class="protocal-span">(9)煽动非法集会、结社、游行、示威、聚众扰乱社会秩序的；</span><br/>
      <span class="protocal-span">(10)以非法民间组织名义活动的；</span><br/>
      <span class="protocal-span">(11)含有法律、行政法规禁止的其他内容的。</span><br/>
      ...
      <span class="protocal-span">(1)不得为任何非法目的而使用网络服务系统；</span><br/>
      <span class="protocal-span">(2)遵守所有与网络服务有关的网络协议、规定和程序；</span><br/>
      <span class="protocal-span">(3)不得利用本站进行任何可能对互联网的正常运转造成不利影响的行为；</span><br/>
      <span class="protocal-span">(4)不得利用本站进行任何不利于本站的行为。</span><br/>
      4.5 如用户在使用网络服务时违反上述任何规定，本站有权要求用户改正或直接采取一切必要的措施(包括但不限于删除用户张贴的内容、暂停或终止用户使用网络服务的权利)以减轻用户不当行为而造成的影响。
    </p>
    <p>
      <span class="subtitle-info">五、隐私保护</span><br/>
      5.1 本站不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本站的非公开内容，但下列情况除外：<br/>
      <span class="protocal-span">(1)事先获得用户的明确授权；</span><br/>
      <span class="protocal-span">(2)根据有关的法律法规要求；</span><br/>
      <span class="protocal-span">(3)按照相关政府主管部门的要求；</span><br/>
      <span class="protocal-span">(4)为维护社会公众的利益。</span><br/>
      5.2 本站可能会与第三方合作向用户提供相关的网络服务，在此情况下，如该第三方同意承担与本站同等的保护用户隐私的责任，则本站有权将用户的注册资料等提供给该第三方。<br/>
      5.3 在不透露单个用户隐私资料的前提下，本站有权对整个用户数据库进行分析并对用户数据库进行商业上的利用。
    </p>
    <p>
      <span class="subtitle-info">六、版权声明</span><br/>
    ...
    <p>
      <span class="subtitle-info">七、责任声明</span><br/>
      ...
      <span class="protocal-span">(1)本站向用户免费提供的各项网络服务；</span><br/>  
      <span class="protocal-span">(2)本站向用户赠送的任何产品或者服务。 </span><br/>
      7.6 本站有权于任何时间暂时或永久修改或终止本服务(或其任何部分)，而无论其通知与否，本站对用户和任何第三人均无需承担任何责任。
    </p>
    <p>
      <span class="subtitle-info">八、附则</span><br/>
    ...
    <div class="am-form-group">
      <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success tpl-login-btn am-btn-block"
        ng-click="agree()">同意</button>
      <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success tpl-login-btn am-btn-block"
        ng-click="disagree()">不同意</button>
    </div>
  </div>
